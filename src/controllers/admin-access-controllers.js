...
// Admin searches REGISTERED students (User collection, role: "user")
// by name, regNo, or email — partial, case-insensitive match.
// Same offset/limit pagination shape as getAllStudent so it drops
// straight into RegisteredStudentsTab.
export const searchRegisteredStudents = async (req, res) => {
    try {
        ...
        // escape regex special chars so user input can't break the pattern
